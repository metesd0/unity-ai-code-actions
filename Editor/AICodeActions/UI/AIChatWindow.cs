...
namespace AICodeActions.UI
{
    ...
    /// - AIChatWindow.cs (main logic, fields, lifecycle)
    /// - AIChatWindow.Toolbar.cs (toolbar and settings UI)
    /// - AIChatWindow.ChatArea.cs (chat message rendering)
    /// - AIChatWindow.InputArea.cs (input and quick actions)
    /// - AIChatWindow.Thinking.cs (thinking animation)
    /// - AIChatWindow.Styles.cs (GUI styles)
    /// </summary>
